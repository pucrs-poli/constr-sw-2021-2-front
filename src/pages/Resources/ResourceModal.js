...
export function ResourceModal(props) {
    ...
    const createEditTemplate = () => (
        <main>
            <DialogContentText>Continue para {actionTextLC()} o recurso <b>{resourceTypeItem.title}</b></DialogContentText>
            <TextField
                margin="dense"
                id="resourceName"
                label="Nome"
    ...
    const deleteTemplate = () => (
        <main>
            <DialogContentText>Tem certeza que deseja excluir o recurso <b>{resourceTypeItem.name}</b>?</DialogContentText>
        </main>
    );
    ...
    return (
        <Dialog open={props.open}>
            <DialogTitle>{`${actionText} Recurso`}</DialogTitle>
            <DialogContent>
                {getTemplate()}
            </DialogContent>
            <DialogActions>
